...
class TestFormatResponse:
    ...
    def test_returns_formatted_text(self) -> None:
        ...
        state = {
            "raw_agent_response": "You should eat more vegetables and lean proteins.",
            "user_name": "Ana",
            "user_language": "en",
        }
    ...
    def test_passes_user_context_to_llm(self) -> None:
        ...
        state = {
            "raw_agent_response": "Eat balanced meals.",
            "user_name": "Carlos",
            "user_language": "es",
        }
    ...
    def test_empty_raw_returns_fallback(self) -> None:
        """When raw_agent_response is empty, return a fallback without calling LLM."""
        state = {
            "raw_agent_response": "",
            "user_name": "Ana",
            "user_language": "en",
    ...
    def test_exception_returns_raw_as_fallback(self) -> None:
        ...
        state = {
            "raw_agent_response": "Eat more fiber.",
            "user_name": None,
            "user_language": "en",
        }
